    ...
    <div class="sidebar-collapse legend">
        <ul class="nav" id="side-menu">
            <li class="sidebar-search"></li>
              ...
              <li>
              	<a id="" href="#" onclick="" ><i class="fa fa-newspaper-o fa-fw"></i> <span class="fa arrow"></span>{{trans('label.notice')}}</a>
              	<ul class="nav nav-second-level">
              		<li><a id="" href="/newNotice"  onclick=""><i class="fa fa-plus-square-o fa-fw"></i>{{trans('label.new_notice')}}</a></li>
              		<li><a id="" href="#"  onclick=""><i class="fa fa-cog fa-fw"></i>{{trans('label.manager_notice')}}</a></li>	
              	</ul>
              </li>
