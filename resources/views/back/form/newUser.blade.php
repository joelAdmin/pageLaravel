...
{!! Html_::fieldset('fieldse1', 'col-md-auto col-md-offset-0', array("fa-newspaper-o", trans('label.info_count'))) !!}
	...
	{!! Form::select_('type', 'type', trans('label.type'), trans('placeholder.select'), trans('title.select_type_user'), array('user' => 'usuario', 'admin' => 'administrador'), null, 1, $errors, array(2,4)) !!}
