<link rel="shortcut icon" href="plantillas/02/css/images/favicon.gif" type="image/x-icon"/> 
<link rel="stylesheet" href="plantillas/02/css/jquery.jcarousel.css" type="text/css" media="all" />
...
<script src="plantillas/02/js/jquery.jcarousel.pack.js" type="text/javascript"></script>
<script type="text/javascript" src="plantillas/02/js/custom_animacion.js"></script>
<!-- **************************** FIN carosuel ***********************************-->
<!-- **************************** LOF JQUERY ***********************************
<link rel="stylesheet" type="text/css" href="librerias/lof_jquery/css/style3.css" />-->
